...
{
	if (c != NULL && rate < c->min_rate)
		return c->min_rate;
	else if (c != NULL && rate > c->max_rate)
		return c->max_rate;
	else if (c != NULL)
		return rate;
	return 0;
...
{
	u32 val = clk_readl(c->reg);
	unsigned long parent_rate = clk_get_rate_locked(c->parent);
	int i;
	for (i = 1; i <= 4; i++) {
...
static struct clk_pll_freq_table tegra_pll_p_freq_table[] = {
	{ 12000000, 216000000, 468, 13, 2, 8},
	{ 19200000, 216000000, 90,   4, 2, 1},
	{ 24000000, 216000000, 468, 26, 2, 8},

	{ 12000000, 234000000, 468, 12, 2, 8},
	{ 13000000, 234000000, 468, 13, 2, 8},
	{ 26000000, 234000000, 468, 26, 2, 8},

	{ 12000000, 432000000, 468, 13, 2, 8},
	{ 19200000, 432000000, 90,   4, 1, 1},
	{ 24000000, 432000000, 468, 26, 1, 8},

	{ 12000000, 468000000, 468, 12, 1, 8},
	{ 13000000, 468000000, 468, 13, 1, 8},
	{ 26000000, 468000000, 468, 26, 1, 8},
...
static struct clk_pll_freq_table tegra_pll_d_freq_table[] = {
	{ 12000000, 234000000, 234, 12, 1, 4},
	{ 13000000, 234000000, 234, 13, 1, 4},
	{ 19200000, 216000000, 135, 12, 1, 3},
	{ 26000000, 234000000, 234, 26, 1, 4},
	...
	{ 12000000, 1040000000, 1040, 12, 1, 12},
	{ 13000000, 1040000000, 1040, 13, 1, 12},
	{ 19200000, 1000000000, 625,  12, 1, 8},
	{ 26000000, 1040000000, 520,  13, 1, 12},
...
static struct clk_pll_freq_table tegra_pll_u_freq_table[] = {
	...
	{ 24000000, 480000000, 1040, 26, 2, 0},
...
/* 1300000, 1196000, 1040000, 832000, 624000, 468000, 312000, 234000 */

static struct clk_pll_freq_table tegra_pll_x_freq_table[] = {
	/* 1.3 GHz */
	{ 12000000, 1300000000, 650,  6,  1, 12},
	{ 13000000, 1300000000, 923,  10, 1, 12},
	{ 19200000, 1300000000, 750,  12, 1, 8},
	{ 26000000, 1300000000, 650,  13, 1, 12},

	/* 1.2 GHz */
	{ 12000000, 1196000000, 598,  6,  1, 12},
	{ 13000000, 1196000000, 1196, 13, 1, 12},
	{ 19200000, 1200000000, 750,  12, 1, 8}, /* todo: 747,5 * 1600000 = 1196000000 */
	{ 26000000, 1196000000, 598,  13, 1, 12},

	/* 1.1 GHz */
	{ 12000000, 1092000000, 546,  6,  1, 12},
	{ 13000000, 1092000000, 1092, 13, 1, 12},
	{ 19200000, 1100000000, 750,  12, 1, 8},
	{ 26000000, 1092000000, 546,  13, 1, 12},

	/* 1 GHz */
	{ 12000000, 1040000000, 520 , 6,  1, 12},
	{ 13000000, 1040000000, 1040, 13, 1, 12},
	{ 19200000, 1000000000, 625,  12, 1, 8},
	{ 26000000, 1040000000, 520,  13, 1, 12},

	/* 936 MHz */
	{ 12000000, 936000000,  936,  12, 1, 12},
	{ 13000000, 936000000,  936,  13, 1, 12},
	{ 19200000, 936000000,  780,  16, 1, 8},
	{ 26000000, 936000000,  936,  26, 1, 12},

	/* 832 MHz */
	{ 12000000, 832000000,  832,  12, 1, 12},
	{ 13000000, 832000000,  832,  13, 1, 12},
	{ 19200000, 832800000,  694,  16, 1, 8},
	{ 26000000, 832000000,  832,  26, 1, 12},

	/* 780 MHz */
	{ 12000000, 780000000,  780,  12, 1, 12},
	{ 13000000, 780000000,  780,  13, 1, 12},
	{ 19200000, 760000000,  950,  24, 1, 8},
	{ 26000000, 780000000,  780,  26, 1, 12},
	...
	/* 468 MHz */
	{ 12000000, 468000000,  468,  12, 1, 12},
	{ 13000000, 468000000,  468,  13, 1, 12},
	{ 19200000, 456000000,  380,  16, 1, 8},
	{ 26000000, 468000000,  468,  26, 1, 12},
	...
	/* 234 MHz */
	{ 12000000, 234000000,  234,  12, 1, 12},
	{ 13000000, 234000000,  234,  13, 1, 12},
	{ 19200000, 234000000,  195,  16, 1, 8},
	{ 26000000, 234000000,  234,  26, 1, 12},
...
{
	RATE_LIMIT("cpu",	780000000, 0x07, 0x10),
	RATE_LIMIT("cclk",	780000000, 0x07, 0x10),
	RATE_LIMIT("pll_x",	780000000, 0x07, 0x10),
	...
	RATE_LIMIT("cpu",	1300000000, 0x14, 0x17, 0x18, 0x1B, 0x1C),
	RATE_LIMIT("cclk",	1300000000, 0x14, 0x17, 0x18, 0x1B, 0x1C),
	RATE_LIMIT("pll_x",	1300000000, 0x14, 0x17, 0x18, 0x1B, 0x1C),
...
static struct tegra_cpufreq_table_data cpufreq_tables[] = {
	...
	{ freq_table_1p0GHz, 1, 6 },
	{ freq_table_1p3GHz, 1, 6 },
};
