...
//	{GPIO,	GPIO_USB_SEL2,			GPIO_OUTPUT,	GPIO_LEVEL_NONE },
	...
	{GPIO,	GPIO_HWREV0,			GPIO_INPUT,	GPIO_LEVEL_NONE,	"GPIO_HWREV0" }, // TEGRA_GPIO_PB1
	{GPIO,	GPIO_HWREV1,			GPIO_INPUT,	GPIO_LEVEL_NONE,	"GPIO_HWREV1" }, // TEGRA_GPIO_PK7
	{GPIO,	GPIO_HWREV2,			GPIO_INPUT,	GPIO_LEVEL_NONE,	"GPIO_HWREV2" }, // TEGRA_GPIO_PU4
	{GPIO,	GPIO_HWREV3,			GPIO_INPUT,	GPIO_LEVEL_NONE,	"GPIO_HWREV3" }, // TEGRA_GPIO_PG0
};
