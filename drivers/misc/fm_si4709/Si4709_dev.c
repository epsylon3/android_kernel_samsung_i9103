...
int Si4709_dev_init(struct i2c_client *client)
{
	...
	Si4709_dev_rst =FM_RESET;
#endif //CONFIG_MACH_N1

	/***reset the device here****/
	gpio_set_value(Si4709_dev_rst, 0);
...
int Si4709_dev_volume_set(u8 volume)
{
	...
	debug("Si4709_dev_volume_set called [%d]", volume);
	...
	//debug("Si4709 05h=0x%x", Si4709_dev.registers[SYSCONFIG2]);
	//debug("Si4709 06h=0x%x", Si4709_dev.registers[SYSCONFIG3]);
	mutex_unlock(&(Si4709_dev.lock));
