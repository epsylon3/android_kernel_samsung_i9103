...
/* woojin80.kim : Below name is used for samsung composite framework. */
...
#ifdef CONFIG_USB_ANDROID_SAMSUNG_COMPOSITE
/* woojin80.kim :  do nothing if we are disabled */
...
#ifdef CONFIG_USB_ANDROID_SAMSUNG_COMPOSITE
/* woojin80.kim : It is for using samsung composite framework. */
